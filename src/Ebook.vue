...
const DOWNLOAD_URL = 'static/Linux_Book.epub' // 载入下载电子书
...
export default {
  ...
  data () {
    return {
      ifTitleAndMenuShow: false, // 是否显示标题栏和菜单
      fontSizeList: [
        { fontSize: 12 },
        { fontSize: 14 },
        { fontSize: 16 },
      ...
      themeList: [
        ...
        },
        {
          ...
          style: {
            body: {
              color: '#000 !important', background: '#ceeaba !important'
            }
          }
        },
        {
        ...
        },
        {
          ...
          style: {
            body: {
              color: '#000 !important', background: 'rgb(241,236,226) !important'
            }
          }
        }
      ], // 主题列表
